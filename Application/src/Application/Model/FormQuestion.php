...
class FormQuestion
{
    ...
    /**
     * @param boolean $question_options
     */
    ...
    /**
     * @param boolean $question_type
     */
    public function setQuestion_type($question_type)
    {
...
//         $this->question->exchangeArray($question);
        ...
        $this->question_type = (!empty($data['question_type'])) ? $data['question_type'] : null;

        $this->question_options = (!empty($data['question_options'])) ? $data['question_options'] : null;
